...
```{r multipleDensityPlot_metGroup, fig.cap = "\\label{fig:multipleDensityPlot_metGroup}Kcat distributions sorted by metabolic context of enzymes", echo=FALSE, warning=FALSE}
```
