...
However, as it has been seen that metabolic context is an important factor at differentiating $K_cat$ values, this should also be taken into account when studying the role of phylogeny.$Figs. S1.15-20$ show that the same trend holds for each of the studied metabolic contexts groups, i.e. enzymes for microbial organisms tend to be faster than those for higher organisms across *all* studied metabolic contexts.
